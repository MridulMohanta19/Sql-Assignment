...
namespace SIS_Library.SIS.Util
{
    public static class DBConnectionUtil
    { 
            private static string connectionString = "Data Source=.\\sqlexpress;Initial Catalog=SISDB;Integrated Security=True;Encrypt=True;Trust Server Certificate=True";
